...
public class AiTrainerRBP extends AiTrainer {
    ...
    public void run() {
        ...
        String folder = "resources/OhHellAIModels/RBP/";
        ...
        asm.setExploration(bidExploration, playExploration);
        aiStrategyModules.add(asm);
        strategyOI.OverallValueLearner ovlo = new strategyOI.OverallValueLearner("resources/OhHellAiModels/OI/ovlN5o40i30.txt");
        strategyOI.ImmediateValueLearner ivlo = new strategyOI.ImmediateValueLearner("resources/OhHellAiModels/OI/ivlN5o40i30.txt");
        for (int i = 1; i < N; i++) {
