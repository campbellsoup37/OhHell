...
public class AiKernel {
    ...
    public List<AiStrategyModule> createDefaultAiStrategyModules(int N, int robotCount) {
        OverallValueLearner ovl = new OverallValueLearner("resources/OhHellAIModels/" + "ovlN" + N + ".txt");
        ImmediateValueLearner ivl = new ImmediateValueLearner("resources/OhHellAIModels/" + "ivlN" + N + ".txt");
